...
type ComplexityRoot struct {
	Query struct {
		Foo func(childComplexity int, input model.FooInput) int
	}
}

type QueryResolver interface {
	Foo(ctx context.Context, input model.FooInput) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.foo":
		...
		return e.complexity.Query.Foo(childComplexity, args["input"].(model.FooInput)), true
...
func (ec *executionContext) field_Query_foo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.FooInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNFooInput2githubᚗcomᚋDesuuuuᚋgqlgenᚑoptionalᚑtestᚋgraphᚋmodelᚐFooInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_foo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().Foo(rctx, fc.Args["input"].(model.FooInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalNFooInput2githubᚗcomᚋDesuuuuᚋgqlgenᚑoptionalᚑtestᚋgraphᚋmodelᚐFooInput(ctx context.Context, v interface{}) (model.FooInput, error) {
